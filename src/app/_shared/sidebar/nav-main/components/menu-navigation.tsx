...
import { buildDashboardMenu, buildWorkspaceMenu } from "../lib/menu-builder"
...
export function MenuNavigation({ showLabel = true, title, emptyMessage }: MenuNavigationProps) {
  ...
  return <DynamicMenu items={menuItems} title={menuTitle} showLabel={showLabel} emptyMessage={menuEmptyMessage} />
}
